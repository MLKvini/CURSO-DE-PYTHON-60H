...
trex1 = pygame.image.load('assets/j1.png')
trex2 = pygame.image.load('assets/j2.png')
trex3 = pygame.image.load('assets/j3.png')
...
pygame.mixer.music.load('assets/song_of_storms.mp3.mp3')
